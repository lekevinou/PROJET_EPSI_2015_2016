 ...
 */
class TypeUnite extends \Entities\TypeUnite implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setNomTypeUnite($nomTypeUnite);
    }

    public function getNomTypeUnite()
    {
        $this->__load();
        return parent::getNomTypeUnite();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'idTypeUnite', 'nomTypeUnite');
    }
